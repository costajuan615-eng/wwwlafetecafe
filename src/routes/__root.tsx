...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Soulful Caribbean-Southern brunch, eggrolls, and comfort classics on Zaragoza Rd, El Paso. 4.6 stars, 260+ ratings." },
      { property: "og:title", content: "La Fête Cafe" },
      { property: "og:description", content: "Caribbean-Southern brunch & soul in El Paso, TX." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "La Fête Cafe" },
